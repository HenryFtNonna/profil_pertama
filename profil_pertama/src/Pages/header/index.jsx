...
export default function Header({ isDarkMode, setIsDarkMode }) {
  ...
  const [activeSection, setActiveSection] = useState('hero'); // State untuk section aktif
  ...
  const scrollToSection = (id) => {
    ...
    if (section) {
      ...
      setActiveSection(id); // Set section aktif saat tombol diklik
    }
  };
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        {/* Tombol Toggle Theme (tetap di kanan) */}
